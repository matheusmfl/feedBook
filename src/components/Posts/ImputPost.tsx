...
export function ImputPost(){
    return(
        ...
        <form className="mt-6">
            ...
            <textarea placeholder='deixe um comentário...'  className="bg-gray1 w-full text-gray6 min-h-[96px] rounded-lg focus:ring focus:ring-green-light text-justify mb-4" />
        </form>
